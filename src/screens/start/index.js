...
class Switch extends Component {
    ...
    render() {
        ...
        return (
                <Toggle defaultToggled={ this.state.isOn } label={<div>
                                                                  <div style={styles.switchName}>
                                                                  <FontIcon className="material-icons" style={styles.lightbulb}color={this.state.isOn ? yellow700 : grey500}>lightbulb_outline</FontIcon>
                                                                  </div>
                                                                  <div style={styles.switchName}>
                                                                  {this.props.name}
                                                                  </div>
